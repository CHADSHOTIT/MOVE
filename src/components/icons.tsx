...
export function ListIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <rect x="3.5" y="10.5" width="17" height="4.5" rx="1" />
